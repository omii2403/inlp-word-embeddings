...
test_words = ['man', 'woman', 'law', 'court', 'city']
analogy_questions = [
    ('brother', 'sister', 'son'),
    ('walk', 'walking', 'swim'),
    ('good', 'better', 'bad'),
...
glove_data = torch.load(embedding_files[[x[0] for x in embedding_files].index("GloVe")][1], weights_only=False)
